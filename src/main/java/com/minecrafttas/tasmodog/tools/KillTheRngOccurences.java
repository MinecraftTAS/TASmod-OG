...
public class KillTheRngOccurences {
	...
	public static final String[][] nextIntDesc = {
		...
		{ "dragonEggTpPositionX", "X position of a dragon egg when teleporting around" },
		{ "dragonEggTpPositionX", "X position of a dragon egg when teleporting around" },
		{ "dragonEggTpPositionY", "Y position of a dragon egg when teleporting around" },
		{ "dragonEggTpPositionY", "Y position of a dragon egg when teleporting around" },
		{ "dragonEggTpPositionZ", "Z position of a dragon egg when teleporting around" },
		{ "dragonEggTpPositionZ", "Z position of a dragon egg when teleporting around" },
		...
		{ "mushroomSpreadPositionY", "Y position of mushroom spreading" },
		{ "mushroomSpreadPositionY", "Y position of mushroom spreading" },
		...
		{ "mushroomSpreadPositionOnFailY", "Y of the new position if the old position is invalid for a mushroom to spawn" },
		{ "mushroomSpreadPositionOnFailY", "Y of the new position if the old position is invalid for a mushroom to spawn" },
		...
		{ "myceliumSpread", "Mycelium spread position x" },
		{ "myceliumSpread", "Mycelium spread position y" },
		{ "myceliumSpread", "Mycelium spread position z" },
		...
		{ "endermanTeleportOffsetY", "Enderman teleport offset y" },
		...
		{ "minecartContentSplit", "Amount of items that get split in 2 different stacks when a minecart is destroyed" },
		{ "minecartContentSplit", "Amount of items that get split in 2 different stacks when a minecart is destroyed" },
		...
		{ "slimeJumpDelay", "Slime jump delay" },
		{ "slimeCanSpawnChance", "Can slime spawn here" },
		{ "slimeSize", "Initial slime size" },
		{ "slimeJumpDelay", "Initial slime jump delay" },
		...
		{ "worldInitialLCG", "Initial world load LCG" },
		{ "worldInitialLCG", "Initial world load LCG" },
		{ "worldInitialLCG", "Initial world load LCG" },
	...
	public static final String[][] nextFloatDesc = {
		...
		{ "entityLivingChasePlayer", "Should a new player be chased" },
		{ "entityLivingChasePlayerYawVelocity", "Random yaw velocity if no player was found to chase" },
		{ "entityLivingChasePlayer", "Should yaw velocity be updated" },
		{ "entityLivingChasePlayerYawVelocity", "Random yaw velocity if no player was found to chase" },
		{ "entityLivingShouldJump", "Should entity jump" },
		{ "minecartInventoryDropPositionX", "X position of the dropped item from a destroyed minecart" },
		{ "minecartInventoryDropPositionY", "Y position of the dropped item from a destroyed minecart" },
		{ "minecartInventoryDropPositionZ", "Z position of the dropped item from a destroyed minecart" },
		{ "minecartInventoryDropPositionX", "X position of the dropped item from a destroyed minecart" },
		{ "minecartInventoryDropPositionY", "Y position of the dropped item from a destroyed minecart" },
		{ "minecartInventoryDropPositionZ", "Z position of the dropped item from a destroyed minecart" },
	...
	public static final String[][] nextGaussianDesc = {
		...
		{ "dispenserInventoryDropMotionY", "Y motion of the dropped inventory from a destroyed dispenser" },
		{ "dispenserInventoryDropMotionY", "Z motion of the dropped inventory from a destroyed dispenser" },
		...
		{ "furnaceInventoryDropMotionY", "Y motion of the dropped inventory from a destroyed furnace" },
		{ "furnaceInventoryDropMotionY", "Z motion of the dropped inventory from a destroyed furnace" },
		...
		{ "minecartInventoryDropMotionX", "X motion of the dropped item from a destroyed minecart" },
		{ "minecartInventoryDropMotionY", "Y motion of the dropped item from a destroyed minecart" },
		{ "minecartInventoryDropMotionZ", "Z motion of the dropped item from a destroyed minecart" },
		{ "minecartInventoryDropMotionX", "X motion of the dropped item from a destroyed minecart" },
		{ "minecartInventoryDropMotionY", "Y motion of the dropped item from a destroyed minecart" },
		{ "minecartInventoryDropMotionZ", "Z motion of the dropped item from a destroyed minecart" },
	...
	public static final String[][] nextDoubleDesc = {
		...
		{ "endermanTeleportOffsetX", "Enderman teleport offset x" },
		{ "endermanTeleportOffsetZ", "Enderman teleport offset z" },
		{ "endermanPickBlockX", "Enderman pick block offset x" },
		{ "endermanPickBlockY", "Enderman pick block offset y" },
		{ "endermanPickBlockZ", "Enderman pick block offset z" },
		{ "endermanPickBlockX", "Enderman pick block offset x" },
		{ "endermanPickBlockY", "Enderman pick block offset y" },
		{ "endermanPickBlockZ", "Enderman pick block offset z" },
		{ "endermanTeleportOffsetX", "Enderman teleport offset x" },
