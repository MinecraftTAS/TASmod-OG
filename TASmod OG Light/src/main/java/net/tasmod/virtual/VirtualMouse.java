...
public class VirtualMouse {
	...
	public static final class VirtualMouseEvent {
		...
		public final String toString() {
			return this.posX + "!" + this.posY + "!" + this.grabbed + "!" + this.eventWheel + "!" + this.eventButton + "!" + this.eventState + "!" + this.dX + "!" + this.dY;
		}
	...
	public final static boolean next() {
		final boolean b = Mouse.next(); // We can poll the Mouse Events to free up ram usage
